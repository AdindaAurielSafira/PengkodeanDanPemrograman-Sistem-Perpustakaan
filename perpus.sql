...
('AG001', 'Van Gogh', 'laki laki', 'Nganjuk', '089876543231', 3, 'Aktif'),
('AG002', 'Da Vinci', 'laki laki', 'Kroya', '081234567890', 1, 'Aktif'),
('AG003', 'Dian Paramita', 'perempuan', 'Tegal', '083214431298', 2, 'Aktif');
...
('BK001', 'Laut Bercerita', 'Leila S. Chudori', 1, 8, 2017, 'baru'),
('BK002', 'Touche', 'Windhy Puspitadewi', 3, 37, 2018, 'baru'),
('BK003', 'Hujan Bulan Juni', 'Sapardi Djoko Damono', 5, 10, 1994, 'baru'),
('BK004', 'Bumi Manusia', 'Pramoedya Ananta Toer', 1, 20, 1980, 'baru');
...
('PJM003', 'AG001', 'BK003', '2020-05-04', 1, 'Dikembalikan', 'Diterima'),
('PJM004', 'AG002', 'BK004', '2020-05-04', 3, 'Dikembalikan', 'Diterima'),
('PJM005', 'AG001', 'BK004', '2020-06-04', 3, 'Dikembalikan', 'Diterima'),
('PJM006', 'AG001', 'BK003', '2020-06-09', 2, NULL, 'Diterima'),
('PJM007', 'AG001', 'BK002', '2020-06-04', 2, NULL, 'Diterima'),
('PJM008', 'AG001', 'BK001', '2020-06-10', 3, NULL, 'Ditolak');
...
('12030122140284', 'Adinda Safira', 'admin', 'admin'),
('12030122140482', 'Febrina Larasati', 'akuntansi', 'anggota');
